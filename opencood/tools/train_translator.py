...
def main():
    ...
    # opencood_train_dataset_subset = Subset(opencood_train_dataset, range(640,660))
    # train_loader = DataLoader(
    #     opencood_train_dataset_subset,
    ...
    if opt.model_dir:
        ...
        if init_epoch == 0:
            ...
            # model = train_utils.load_merged_model(saved_path, model)
        lowest_val_epoch = init_epoch
    ...
    # cmd = f"CUDA_VISIBLE_DEVICES={os.environ['CUDA_VISIBLE_DEVICES']} python opencood/tools/inference.py --model_dir {saved_path} --fusion_method {fusion_method}"
