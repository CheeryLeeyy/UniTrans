...
class CML(nn.Module):
    ...
    def forward(self, x):
        # print(f"conv3d_input:{x.shape}")
        x = self.conv3d_1(x)
        # print(f"conv3d_1:{x.shape}")
        x = self.conv3d_2(x)
        # print(f"conv3d_2:{x.shape}")
        x = self.conv3d_3(x)
        # print(f"conv3d_3:{x.shape}")
        return x
class CML2(nn.Module):
    def __init__(self):
        super(CML2, self).__init__()
        self.conv3d_1 = Conv3d(64, 64, 3, s=(2, 1, 1), p=(1, 1, 1))
        self.conv3d_2 = Conv3d(64, 64, 3, s=(1, 1, 1), p=(0, 1, 1))
        self.conv3d_3 = Conv3d(64, 64, 3, s=(1, 1, 1), p=(1, 1, 1))
        self.conv3d_4 = Conv3d(64, 64, 3, s=(2, 1, 1), p=(1, 1, 1))
...
class CML3(nn.Module):
    def __init__(self):
        super(CML3, self).__init__()
        self.conv3d_1 = Conv3d(64, 64, 3, s=(2, 1, 1), p=(1, 1, 1))
        self.conv3d_2 = Conv3d(64, 64, 3, s=(1, 1, 1), p=(0, 1, 1))
        self.conv3d_3 = Conv3d(64, 64, 3, s=(1, 1, 1), p=(1, 1, 1))
        self.conv3d_4 = Conv3d(64, 64, 3, s=(1, 1, 1), p=(1, 1, 1))
        self.conv3d_5 = Conv3d(64, 64, 3, s=(2, 1, 1), p=(1, 1, 1))
